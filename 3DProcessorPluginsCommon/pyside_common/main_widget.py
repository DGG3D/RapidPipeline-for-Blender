...
#ADDITIONAL_SPACING = int(os.environ.get("RPD_ADDITIONAL_ACTION_SPACING", "0"))
...
class MainWidget(QtWidgets.QWidget):
    def __init__(self, tool: str, plugin_root: str, version:str = "0.0.0"):
        ...
        # NOTE: this flag will only take effect once
        ...
        self._is_cad_version : bool = os.path.isdir(os.path.join(self.plugin_root, "rpde", "hoops"))
        self.dialog_file = ""
        ...
        self.main_menu.key_button.pressed.connect(self.overrideLicense)
        self.main_menu.settings_button.pressed.connect(self.onSettingsPressed)
        self.main_menu.help_button.pressed.connect(self.onHelpPressed)
        ...
        self.footer_widget.run_button.pressed.connect(self.runButtonPressed)
    ...
    def setupProcessingMenu(self):
        ...
        self.processing_menu.import_button.pressed.connect(self.importPressed)
        self.processing_menu.export_button.pressed.connect(self.exportPressed)
    ...
    def importPressed(self):
        ...
        import_dialog = ImportDialog(self, self.schema, self.import_actions, False)
    ...
    def exportPressed(self):
        ...
        #  open the separate import dialog, so the user can select an import action
        export_dialog = ExportDialog(self, self.schema, self.export_actions, export_extension, False)
        ...
        if clicked_btn < 0:
            ...
            action_utils.overrideExports(export_config, export_extension, skip_name=True) # we don't want a name override
    ...
    def runProcessor(
        ...
        rpde_path = os.path.join(self.plugin_root, "rpde", "rpde.exe")
    ...
    def createSettingsMenu(self) -> Tuple[QtWidgets.QMenu, Dict[str, QtGui.QAction]]:
        """
        ...
        preview_action = QtGui.QAction("Show Actions Preview", settings_menu)
        ...
        skip_action = QtGui.QAction("Skip Confirmation Dialog", settings_menu)
    ...
    def createHelpMenu(self) -> Tuple[QtWidgets.QMenu, Dict[str, QtGui.QAction]]:
        """
        Creates the help menu that pops up once the help button is used.
        """
        ...
        docs_action = QtGui.QAction(pyside_utils.getIcon("doc"), "Plugin Documentation", help_menu)
        ...
        feedback_action = QtGui.QAction(pyside_utils.getIcon("feedback"), "Feedback", help_menu)
        ...
        support_action = QtGui.QAction(pyside_utils.getIcon("support"), "Contact Support", help_menu)
        ...
        about_action = QtGui.QAction(pyside_utils.getIcon("info"), "About the Plugin", help_menu)
