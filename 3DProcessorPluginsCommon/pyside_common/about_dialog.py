...
class AboutDialog(QtWidgets.QDialog):
    def __init__(self, parent: QtWidgets.QWidget, tool:str, plugin_version:str, plugin_root:str):
        ...
        license_str = f"The RapidPipeline Plugin for {tool} is licensed under the MIT License (excluding the RapidPipeline engine).\n"
        license_str += "Uses PySide6 libraries, licensed as LGPLv3. Full licenses below."
        ...
        self.main_layout.addWidget(self.license_view)

        # TODO: icons need a license
