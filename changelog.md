...
* Improved UI for Drop Textures
* Improved general UI performance
* Fixed support for Animations
* Fixed issue related to CAD Optimization
* Selecting empty object now runs optimization on all children
* Improved naming of newly created nodes and collections
* Improved feedback workflow
* Fixed a bug related to 3D import
* Added new Magic Actions
  * Generate UV Atlas
  * Generate Tiling UVs

### Version v1.0.0 August 07th, 2025
...
### Version v0.2.1 April 24th, 2025
...
### Version v0.2.1-1 May 02nd, 2025
...
### Version v0.2.0 March 25th, 2025
...
### Version v0.1.3 November 11th, 2024
